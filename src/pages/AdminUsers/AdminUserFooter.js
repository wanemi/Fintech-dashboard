...
import classes from "./AdminUserFooter.module.css";


const AdminUserFooter = ({goToNextPage, goToPreviousPage, TotalPages, currentPage}) => {
  ...
  return (
    <tfoot className={classes.container}>
      <tr>
        ...
        <td colspan="7" className={classes.text}>
